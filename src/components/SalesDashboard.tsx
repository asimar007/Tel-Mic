        ...
        <div className="h-full flex flex-col p-1 space-y-2">
          ...
          <div className="flex items-end justify-between flex-wrap gap-4">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400 text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight">
                272,925,484
              </span>
            </div>
            <div className="flex flex-col items-end">
              <div className="flex items-center gap-1">
                <TrendingUpIcon className="w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-green-400" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400 text-3xl md:text-4xl lg:text-5xl font-bold">
                  49%
                </span>
              </div>
              <span className="text-cyan-200 text-base md:text-lg lg:text-xl">
                達成率
              </span>
            </div>
          </div>
